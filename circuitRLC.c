...
/* Définition de la fonction de la méthode d'Euler */
...
/* Définition de la fonction de la méthode de Runge-Kutta 4 */
void rk4(double S[2],double U[2][N], double t[N], double t_i, double t_f,double E,double R,double L,double C){
    double k1[2], k2[2], k3[2], k4[2];  //k1, k2, k3, k4 de dimension 2
    double dt;                          
    double U_t[2];                      // Vecteur contenant u et du/dt pour un temps t
